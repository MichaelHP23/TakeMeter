...
Original file is located at
    https://colab.research.google.com/drive/12GlrDiDFcZP3n5DdFSR7mYvaBGmzuWic
"""
...
analysis: A structured argument with specific evidence — named episodes, scenes, character arcs, animation techniques, or thematic patterns that another viewer could verify or dispute. The post argues toward a conclusion rather than just asserting one.
Example: "Mob Psycho 100's animation quality drops in S2E5 aren't budget cuts — Bones intentionally uses rougher key frames during Mob's emotional breakdowns to mirror his loss of control. Compare the clean lines in the Claw fights vs the sketchy style when he hits ???%."

hot_take: A bold, confident opinion stated without supporting evidence. The post asserts rather than argues — it may name a show or character but gives no specific evidence someone could evaluate.
Example: "Demon Slayer is carried entirely by Ufotable's animation. Without it, the story is mid shonen at best. Fight me."

reaction: An immediate emotional response to a specific moment or event, with little to no argument. Often short, uses caps or exclamation marks, expresses a feeling rather than a judgment.
Example: "JUST FINISHED CLANNAD AFTER STORY AND I AM NOT OKAY. That field scene broke me completely"
